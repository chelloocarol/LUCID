...
|-----|-----|-------|---------|-----|-----------------|
| Student | CPU | 1088×1920 | **19567 ms** | **0.1** | 36.5 ms / 27.4 FPS |
| LUCIDMine | CPU | 1088×1920 | 待测 | 待测 | 37.3 ms / 26.8 FPS |

**结论**: GPU/CPU 速度差约 535 倍，CPU 时延无实际参考价值。Modal A10G 额度已耗尽，无法运行 GPU 基准，FPS/时延声明本次审查无法独立验证。
